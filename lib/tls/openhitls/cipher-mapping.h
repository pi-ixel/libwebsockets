/*
 * OpenSSL cipher alias to IANA / standard-name mapping for OpenHiTLS lookup.
 */

struct lws_openhitls_cipher_map_entry {
	const char *openssl_name;
	const char *iana_name;
};

static const struct lws_openhitls_cipher_map_entry
lws_openhitls_cipher_map[] = {
